// sections.premium.draft.ts
// 19 renderers HTML inline — DTC premium (niveau Glossier / Mejuri / Ridge / Allbirds).
// Chaque fn retourne '' si sa data est absente/vide — silent skip garanti.
// Theming exclusivement via SectionTheme. Aucune couleur hardcodée
// sauf #DC2626 (danger red) et #059669 (success green) dans comparison + competitor.

import type { LandingPageData } from '@/types'
import type { SectionTheme } from './sections'
import { DEFAULT_THEME } from './sections'
