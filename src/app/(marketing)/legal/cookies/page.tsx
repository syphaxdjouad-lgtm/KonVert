      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-5 sm:px-8">
          ...
          <P>
            ...
            lors de la visite d&apos;un site web. Les cookies permettent au site de reconnaître votre appareil et de
            mémoriser certaines informations relatives à votre visite, comme vos préférences ou votre statut de connexion.
          </P>

          <H2>2. Cookies utilisés par Konvert</H2>

          <h3 className="text-base font-semibold text-gray-800 mb-3 mt-4">Cookies strictement nécessaires</h3>
            ...
            <table className="w-full text-sm text-gray-600 border-collapse">
              ...
              <tbody>
                {[
                  ...
                  ['cookie-consent', 'Mémorisation de votre choix cookies', '12 mois'],
          ...
          <P>
            Ces cookies nous aident à comprendre comment les visiteurs utilisent le site afin d&apos;améliorer notre service.
          ...
          <P>
            Certains services tiers intégrés à Konvert (comme Stripe pour le paiement) peuvent déposer leurs propres cookies.
            Ces cookies sont soumis aux politiques de confidentialité de leurs fournisseurs respectifs.
            Konvert n&apos;a aucun contrôle sur ces cookies tiers.
          </P>
          ...
          <ul className="text-sm text-gray-600 leading-relaxed mb-6 list-disc pl-5 space-y-1">
            ...
            <li><strong>Via votre navigateur :</strong> chaque navigateur propose des paramètres de gestion des cookies dans ses options de confidentialité</li>
          </ul>
          <P>
            La désactivation de certains cookies peut affecter votre expérience de navigation et limiter l&apos;accès
            à certaines fonctionnalités du Service.
          </P>

          <H2>4. Durée de conservation</H2>
          <P>
            Conformément aux recommandations de la CNIL, les cookies de mesure d&apos;audience sont conservés pour une
            durée maximale de <strong>13 mois</strong>. Les cookies de session sont supprimés à la fermeture de votre navigateur.
            Le cookie de consentement est conservé pendant <strong>12 mois</strong>.
          </P>

          <H2>5. Base légale</H2>
          <P>
            Les cookies strictement nécessaires sont déposés sur la base de notre intérêt légitime à assurer le
            fonctionnement du Service. Les cookies d&apos;analyse sont déposés uniquement après obtention de votre
            consentement, conformément à l&apos;article 82 de la loi Informatique et Libertés et aux directives de la CNIL.
          </P>
