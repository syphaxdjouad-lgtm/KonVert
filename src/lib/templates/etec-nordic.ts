  ...
  <div class="product-grid-nd" style="display:grid;grid-template-columns:1fr 1fr;gap:80px;max-width:1280px;margin:0 auto;padding:96px 64px;align-items:start;">
    ...
    <div>
      ...
      <div style="display:flex;align-items:center;gap:20px;flex-wrap:wrap;">
        <div style="display:flex;align-items:center;gap:6px;color:${C.muted};"><span style="color:${C.accentWarm};">${ico.truck(14)}</span><span style="font-family:'Manrope',sans-serif;font-size:11px;">${trans(lang, 'trust.freeShippingOffered')}</span></div>
        <div style="display:flex;align-items:center;gap:6px;color:${C.muted};"><span style="color:${C.accentWarm};">${ico.return(14)}</span><span style="font-family:'Manrope',sans-serif;font-size:11px;">${trans(lang, 'trust.returnDays', { n: 30 })}</span></div>
        <div style="display:flex;align-items:center;gap:6px;color:${C.muted};"><span style="color:${C.accentWarm};">${ico.shield(14)}</span><span style="font-family:'Manrope',sans-serif;font-size:11px;">${trans(lang, 'hero.securePayment')}</span></div>
      </div>
    </div>
  </div>
</section>
