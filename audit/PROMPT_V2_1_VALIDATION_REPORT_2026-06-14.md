...
**Golden set** : 30 produits (10 grandes marques / 9 DTC inconnues / 10 AliExpress génériques)
**Runs réussis** : 29/30
**Coût estimé golden set** : ~2.0 centimes d'€ (DeepSeek + Haiku judge)
...
| Runs avec press_logos=[] (comportement correct) | 22/29 (76%) |
| Runs avec ≥1 logo retourné | 7/29 |
| Logos jugés total | 12 |
| dont hallucinated | 0 |
| dont verified | 0 |
| dont unverifiable | 12 |
...
|---|---|---|---|---|
| **A — Grandes marques connues** | 10 | 40% | 0.0% | Acceptable si publication cohérente niche |
| **B — DTC boutiques inconnues** | 9 | 89% | 0.0% | Devrait être quasi 100% [] |
| **C — AliExpress génériques** | 10 | 100% | 0.0% | Doit être 100% [] |
...
| A02 | A | Casper | [] | 0 | 0 | 0 | - |
| A03 | A | Glossier | Vogue, Allure, Refinery29 | 0 | 0 | 3 | - |
| A04 | A | Dollar Shave Club | Le Figaro | 0 | 0 | 1 | - |
| A05 | A | Away Travel | Vogue, Forbes | 0 | 0 | 2 | - |
| A06 | A | Warby Parker | Vogue | 0 | 0 | 1 | - |
| A07 | A | Oura Ring | [] | 0 | 0 | 0 | - |
| A08 | A | Drunk Elephant | [] | 0 | 0 | 0 | - |
| A09 | A | Peak Design | Wired | 0 | 0 | 1 | - |
| A10 | A | Lululemon | Vogue, Elle | 0 | 0 | 2 | - |
| B01 | B | LuminaSkin (boutique Shopify inconn | Vogue, Marie Claire | 0 | 0 | 2 | - |
...
| B09 | B | ActiveMom France (boutique Shopify  | [] | 0 | 0 | 0 | JSON invalide reçu de DeepSeek — réessai |
...
| C07 | C | Générique AliExpress — vendeur Home | [] | 0 | 0 | 0 | - |
...
_Rapport généré automatiquement par MINATO — 2026-06-14T20:36:22.543Z_