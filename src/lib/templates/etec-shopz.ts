...
const T: Record<string, Record<string, string>> = {
  promo_bar:            { fr: '🎁 Promo — Obtenez 25% de cashback sur votre première commande', en: '🎁 Promo — Get 25% Cash Back on your first order', es: '🎁 Promo — Obtén 25% de reembolso en tu primer pedido', de: '🎁 Aktion — 25% Cashback auf deine erste Bestellung', it: '🎁 Promo — Ottieni il 25% di Cashback sul tuo primo ordine', pt: '🎁 Promo — Obtenha 25% de Cashback na sua primeira encomenda', nl: '🎁 Actie — Ontvang 25% Cashback op je eerste bestelling', ar: '🎁 عرض — احصل على استرداد 25% على طلبك الأول', zh: '🎁 促销 — 首单立享25%返现' },
  nav_home:             { fr: 'Accueil', en: 'Home', es: 'Inicio', de: 'Startseite', it: 'Home', pt: 'Início', nl: 'Home', ar: 'الرئيسية', zh: '首页' },
  nav_catalogue:        { fr: 'Catalogue', en: 'Catalogue', es: 'Catálogo', de: 'Katalog', it: 'Catalogo', pt: 'Catálogo', nl: 'Catalogus', ar: 'الكتالوج', zh: '目录' },
  nav_new:              { fr: 'Nouveautés', en: 'New Arrivals', es: 'Novedades', de: 'Neuheiten', it: 'Novità', pt: 'Novidades', nl: 'Nieuwe Producten', ar: 'الوافدون الجدد', zh: '新品上市' },
  nav_promo:            { fr: 'Promotions', en: 'Promotions', es: 'Promociones', de: 'Aktionen', it: 'Promozioni', pt: 'Promoções', nl: 'Acties', ar: 'العروض', zh: '促销活动' },
  breadcrumb_products:  { fr: 'Produits', en: 'Products', es: 'Productos', de: 'Produkte', it: 'Prodotti', pt: 'Produtos', nl: 'Producten', ar: 'المنتجات', zh: '产品' },
  badge_sold:           { fr: 'ventes', en: 'Sold', es: 'vendidos', de: 'verkauft', it: 'venduti', pt: 'vendidos', nl: 'verkocht', ar: 'مباع', zh: '已售' },
  badge_reviews:        { fr: 'avis', en: 'reviews', es: 'reseñas', de: 'Bewertungen', it: 'recensioni', pt: 'avaliações', nl: 'beoordelingen', ar: 'تقييم', zh: '条评论' },
  label_color:          { fr: 'Couleur :', en: 'Color:', es: 'Color:', de: 'Farbe:', it: 'Colore:', pt: 'Cor:', nl: 'Kleur:', ar: 'اللون :', zh: '颜色：' },
  label_size:           { fr: 'Taille :', en: 'Size:', es: 'Talla:', de: 'Größe:', it: 'Taglia:', pt: 'Tamanho:', nl: 'Maat:', ar: 'المقاس :', zh: '尺寸：' },
  color_green:          { fr: 'Vert', en: 'Green', es: 'Verde', de: 'Grün', it: 'Verde', pt: 'Verde', nl: 'Groen', ar: 'أخضر', zh: '绿色' },
  color_beige:          { fr: 'Beige sable', en: 'Sand Beige', es: 'Beige arena', de: 'Sandbeige', it: 'Beige Sabbia', pt: 'Bege Areia', nl: 'Zandbeige', ar: 'بيج رملي', zh: '沙米色' },
  color_grey:           { fr: 'Gris ardoise', en: 'Slate Grey', es: 'Gris pizarra', de: 'Schiefergrau', it: 'Grigio Ardesia', pt: 'Cinza Ardósia', nl: 'Leigrijs', ar: 'رمادي أردوازي', zh: '石板灰' },
  size_xs:              { fr: 'XS', en: 'XS', es: 'XS', de: 'XS', it: 'XS', pt: 'XS', nl: 'XS', ar: 'XS', zh: 'XS' },
  size_s:               { fr: 'S', en: 'S', es: 'S', de: 'S', it: 'S', pt: 'S', nl: 'S', ar: 'S', zh: 'S' },
  size_m:               { fr: 'M', en: 'M', es: 'M', de: 'M', it: 'M', pt: 'M', nl: 'M', ar: 'M', zh: 'M' },
  size_l:               { fr: 'L', en: 'L', es: 'L', de: 'L', it: 'L', pt: 'L', nl: 'L', ar: 'L', zh: 'L' },
  size_xl:              { fr: 'XL', en: 'XL', es: 'XL', de: 'XL', it: 'XL', pt: 'XL', nl: 'XL', ar: 'XL', zh: 'XL' },
  size_xxl:             { fr: 'XXL', en: 'XXL', es: 'XXL', de: 'XXL', it: 'XXL', pt: 'XXL', nl: 'XXL', ar: 'XXL', zh: 'XXL' },
  size_xsmall:          { fr: 'Très petit', en: 'XSmall', es: 'XPequeño', de: 'XKlein', it: 'XPiccolo', pt: 'XPequeno', nl: 'XKlein', ar: 'صغير جداً', zh: '超小码' },
  size_small:           { fr: 'Petit', en: 'Small', es: 'Pequeño', de: 'Klein', it: 'Piccolo', pt: 'Pequeno', nl: 'Klein', ar: 'صغير', zh: '小码' },
  size_medium:          { fr: 'Moyen', en: 'Medium', es: 'Mediano', de: 'Mittel', it: 'Medio', pt: 'Médio', nl: 'Middel', ar: 'وسط', zh: '中码' },
  size_large:           { fr: 'Grand', en: 'Large', es: 'Grande', de: 'Groß', it: 'Grande', pt: 'Grande', nl: 'Groot', ar: 'كبير', zh: '大码' },
  size_xlarge:          { fr: 'Très grand', en: 'XLarge', es: 'XGrande', de: 'XGroß', it: 'XGrande', pt: 'XGrande', nl: 'XGroot', ar: 'كبير جداً', zh: '超大码' },
  size_xxlarge:         { fr: 'XXL', en: 'XXLarge', es: 'XXGrande', de: 'XXGroß', it: 'XXGrande', pt: 'XXGrande', nl: 'XXGroot', ar: 'XXL', zh: 'XXL码' },
  btn_buy:              { fr: 'Acheter maintenant', en: 'Buy this Item', es: 'Comprar ahora', de: 'Jetzt kaufen', it: 'Acquista ora', pt: 'Comprar agora', nl: 'Nu kopen', ar: 'اشترِ الآن', zh: '立即购买' },
  btn_chat:             { fr: 'Chat', en: 'Chat', es: 'Chat', de: 'Chat', it: 'Chat', pt: 'Chat', nl: 'Chat', ar: 'محادثة', zh: '聊天' },
  btn_wishlist:         { fr: 'Favoris', en: 'Wishlist', es: 'Favoritos', de: 'Wunschliste', it: 'Preferiti', pt: 'Favoritos', nl: 'Verlanglijst', ar: 'المفضلة', zh: '心愿单' },
  btn_share:            { fr: 'Partager', en: 'Share', es: 'Compartir', de: 'Teilen', it: 'Condividi', pt: 'Partilhar', nl: 'Delen', ar: 'مشاركة', zh: '分享' },
  btn_added_cart:       { fr: '✓ Ajouté au panier', en: '✓ Added to Cart', es: '✓ Añadido al carrito', de: '✓ In den Warenkorb gelegt', it: '✓ Aggiunto al carrello', pt: '✓ Adicionado ao carrinho', nl: '✓ Toegevoegd aan winkelwagen', ar: '✓ تمت الإضافة', zh: '✓ 已加入购物车' },
  btn_add_wishlist:     { fr: 'Ajouter aux favoris', en: 'Add to Wishlist', es: 'Añadir a favoritos', de: 'Zur Wunschliste hinzufügen', it: 'Aggiungi ai preferiti', pt: 'Adicionar aos favoritos', nl: 'Toevoegen aan verlanglijst', ar: 'أضف إلى المفضلة', zh: '加入心愿单' },
  tab_details:          { fr: 'Détails', en: 'Details', es: 'Detalles', de: 'Details', it: 'Dettagli', pt: 'Detalhes', nl: 'Details', ar: 'التفاصيل', zh: '详情' },
  tab_reviews:          { fr: 'Avis', en: 'Reviews', es: 'Reseñas', de: 'Bewertungen', it: 'Recensioni', pt: 'Avaliações', nl: 'Beoordelingen', ar: 'التقييمات', zh: '评论' },
  tab_discussion:       { fr: 'Discussion', en: 'Discussion', es: 'Discusión', de: 'Diskussion', it: 'Discussione', pt: 'Discussão', nl: 'Discussie', ar: 'النقاش', zh: '讨论' },
  details_title:        { fr: 'Détails du produit', en: 'Product Details', es: 'Detalles del producto', de: 'Produktdetails', it: 'Dettagli del Prodotto', pt: 'Detalhes do Produto', nl: 'Productdetails', ar: 'تفاصيل المنتج', zh: '产品详情' },
  detail_quality:       { fr: 'Matériaux de haute qualité', en: 'Premium quality materials', es: 'Materiales de alta calidad', de: 'Hochwertige Materialien', it: 'Materiali di alta qualità', pt: 'Materiais de alta qualidade', nl: 'Hoogwaardige materialen', ar: 'مواد عالية الجودة', zh: '优质材料' },
  detail_comfort:       { fr: 'Confort optimal pour une utilisation quotidienne', en: 'Optimal comfort for everyday use', es: 'Comodidad óptima para uso diario', de: 'Optimaler Komfort für den täglichen Gebrauch', it: 'Comfort ottimale per l\'uso quotidiano', pt: 'Conforto ideal para o uso diário', nl: 'Optimaal comfort voor dagelijks gebruik', ar: 'راحة مثلى للاستخدام اليومي', zh: '为日常使用打造的极致舒适' },
  detail_care:          { fr: 'Entretien facile', en: 'Easy care', es: 'Fácil cuidado', de: 'Pflegeleicht', it: 'Facile manutenzione', pt: 'Fácil manutenção', nl: 'Eenvoudig onderhoud', ar: 'سهل العناية', zh: '易于打理' },
  detail_variants:      { fr: 'Disponible en plusieurs variantes', en: 'Available in multiple variants', es: 'Disponible en múltiples variantes', de: 'In mehreren Varianten erhältlich', it: 'Disponibile in più varianti', pt: 'Disponível em várias variantes', nl: 'Verkrijgbaar in meerdere varianten', ar: 'متوفر بعدة خيارات', zh: '提供多种款式' },
  detail_sustainable:   { fr: 'Matériaux responsables et durables', en: 'Responsible and sustainable materials', es: 'Materiales responsables y sostenibles', de: 'Verantwortungsvolle und nachhaltige Materialien', it: 'Materiali responsabili e sostenibili', pt: 'Materiais responsáveis e sustentáveis', nl: 'Verantwoorde en duurzame materialen', ar: 'مواد مسؤولة ومستدامة', zh: '负责任的可持续材料' },
  reviews_title:        { fr: 'Avis clients', en: 'Reviews', es: 'Reseñas', de: 'Bewertungen', it: 'Recensioni', pt: 'Avaliações', nl: 'Beoordelingen', ar: 'التقييمات', zh: '客户评论' },
  reviews_showing:      { fr: 'Affichage de 5 sur 225 avis', en: 'Showing 5 from 225 reviews', es: 'Mostrando 5 de 225 reseñas', de: '5 von 225 Bewertungen angezeigt', it: 'Visualizzazione di 5 su 225 recensioni', pt: 'A mostrar 5 de 225 avaliações', nl: '5 van 225 beoordelingen weergegeven', ar: 'عرض 5 من 225 تقييم', zh: '显示225条评论中的5条' },
  reviews_sort_latest:  { fr: 'Plus récents ↓', en: 'Latest ↓', es: 'Más recientes ↓', de: 'Neueste ↓', it: 'Più recenti ↓', pt: 'Mais recentes ↓', nl: 'Nieuwste ↓', ar: 'الأحدث ↓', zh: '最新 ↓' },
  reviews_sort_top:     { fr: 'Mieux notés', en: 'Highest Rated', es: 'Mejor valorados', de: 'Am besten bewertet', it: 'Più votati', pt: 'Mais bem avaliados', nl: 'Best beoordeeld', ar: 'الأعلى تقييماً', zh: '评分最高' },
  reviews_sort_helpful: { fr: 'Plus utiles', en: 'Most Helpful', es: 'Más útiles', de: 'Am hilfreichsten', it: 'Più utili', pt: 'Mais úteis', nl: 'Meest nuttig', ar: 'الأكثر فائدة', zh: '最有帮助' },
  reviews_show_all:     { fr: 'Voir tous les avis', en: 'Show all reviews', es: 'Ver todas las reseñas', de: 'Alle Bewertungen anzeigen', it: 'Vedi tutte le recensioni', pt: 'Ver todas as avaliações', nl: 'Alle beoordelingen bekijken', ar: 'عرض جميع التقييمات', zh: '查看所有评论' },
  review_reply:         { fr: 'Répondre', en: 'Reply', es: 'Responder', de: 'Antworten', it: 'Rispondi', pt: 'Responder', nl: 'Reageren', ar: 'رد', zh: '回复' },
  reviews_based_on:     { fr: 'Basé sur 225 avis', en: 'Based on 225 reviews', es: 'Basado en 225 reseñas', de: 'Basierend auf 225 Bewertungen', it: 'Basato su 225 recensioni', pt: 'Com base em 225 avaliações', nl: 'Gebaseerd op 225 beoordelingen', ar: 'بناءً على 225 تقييم', zh: '基于225条评论' },
  discussion_empty:     { fr: 'Aucune discussion pour l\'instant. Soyez le premier à démarrer une conversation.', en: 'No discussions yet. Be the first to start a conversation about this product.', es: 'Sin discusiones aún. Sé el primero en iniciar una conversación.', de: 'Noch keine Diskussionen. Starte als Erste(r) ein Gespräch über dieses Produkt.', it: 'Nessuna discussione per ora. Sii il primo ad avviare una conversazione su questo prodotto.', pt: 'Ainda sem discussões. Seja o primeiro a iniciar uma conversa sobre este produto.', nl: 'Nog geen discussies. Wees de eerste die een gesprek start over dit product.', ar: 'لا توجد نقاشات بعد. كن أول من يبدأ محادثة.', zh: '暂无讨论，快来发表第一条评论吧。' },
  related_title:        { fr: 'Vous pourriez aimer', en: 'You Might Like This Product', es: 'También te puede gustar', de: 'Das könnte dir auch gefallen', it: 'Potrebbe piacerti anche', pt: 'Também pode gostar', nl: 'Dit vind je misschien ook leuk', ar: 'قد يعجبك أيضاً', zh: '你可能还会喜欢' },
  related_badge_new:    { fr: 'Nouveauté', en: 'New Arrivals', es: 'Novedades', de: 'Neuheiten', it: 'Novità', pt: 'Novidades', nl: 'Nieuwe Producten', ar: 'وصل حديثاً', zh: '新品' },
  footer_brand_desc:    { fr: 'Produits premium sélectionnés pour leur qualité et leur exclusivité.', en: 'Premium products selected for their quality and exclusivity.', es: 'Productos premium seleccionados por su calidad y exclusividad.', de: 'Premium-Produkte, ausgewählt für ihre Qualität und Exklusivität.', it: 'Prodotti premium selezionati per qualità ed esclusività.', pt: 'Produtos premium selecionados pela sua qualidade e exclusividade.', nl: 'Premium producten geselecteerd om hun kwaliteit en exclusiviteit.', ar: 'منتجات مميزة مختارة بعناية لجودتها وحصريتها.', zh: '精选优质独家产品。' },
  footer_about:         { fr: 'À propos', en: 'About Us', es: 'Sobre nosotros', de: 'Über uns', it: 'Chi Siamo', pt: 'Sobre Nós', nl: 'Over Ons', ar: 'من نحن', zh: '关于我们' },
  footer_information:   { fr: 'Informations', en: 'Information', es: 'Información', de: 'Informationen', it: 'Informazioni', pt: 'Informações', nl: 'Informatie', ar: 'معلومات', zh: '信息' },
  footer_store_locator: { fr: 'Trouver un magasin', en: 'Store Locator', es: 'Localizador de tiendas', de: 'Filialfinder', it: 'Trova un Negozio', pt: 'Localizador de Lojas', nl: 'Winkelzoeker', ar: 'أماكن المتاجر', zh: '门店查找' },
  footer_bulk:          { fr: 'Achat en gros', en: 'Bulk Purchase', es: 'Compra al por mayor', de: 'Großeinkauf', it: 'Acquisto all\'Ingrosso', pt: 'Compra por Grosso', nl: 'Groothandelsaankoop', ar: 'شراء بالجملة', zh: '批量采购' },
  footer_alteration:    { fr: 'Service de retouche', en: 'Alteration Service', es: 'Servicio de modificaciones', de: 'Änderungsservice', it: 'Servizio di Sartoria', pt: 'Serviço de Alterações', nl: 'Verstelservice', ar: 'خدمة التعديل', zh: '改衣服务' },
  footer_gift:          { fr: 'Livraison cadeau', en: 'Gift Delivery', es: 'Entrega de regalos', de: 'Geschenklieferung', it: 'Consegna Regalo', pt: 'Entrega de Presente', nl: 'Cadeaubezorging', ar: 'توصيل الهدايا', zh: '礼品配送' },
  footer_live:          { fr: 'Live Station', en: 'Live Station', es: 'Live Station', de: 'Live Station', it: 'Live Station', pt: 'Live Station', nl: 'Live Station', ar: 'البث المباشر', zh: '直播间' },
  ...
  footer_guide:         { fr: 'Guide d\'achat en ligne', en: 'Online Shopping Guide', es: 'Guía de compras online', de: 'Online-Einkaufsführer', it: 'Guida allo Shopping Online', pt: 'Guia de Compras Online', nl: 'Online Winkelgids', ar: 'دليل التسوق عبر الإنترنت', zh: '在线购物指南' },
  footer_return:        { fr: 'Politique de retour', en: 'Return Policy', es: 'Política de devoluciones', de: 'Rückgaberichtlinie', it: 'Politica di Reso', pt: 'Política de Devolução', nl: 'Retourbeleid', ar: 'سياسة الإرجاع', zh: '退货政策' },
  footer_privacy:       { fr: 'Politique de confidentialité', en: 'Privacy Policy', es: 'Política de privacidad', de: 'Datenschutzrichtlinie', it: 'Informativa sulla Privacy', pt: 'Política de Privacidade', nl: 'Privacybeleid', ar: 'سياسة الخصوصية', zh: '隐私政策' },
  footer_accessibility: { fr: 'Accessibilité', en: 'Accessibility', es: 'Accesibilidad', de: 'Barrierefreiheit', it: 'Accessibilità', pt: 'Acessibilidade', nl: 'Toegankelijkheid', ar: 'إمكانية الوصول', zh: '无障碍' },
  footer_contact:       { fr: 'Nous contacter', en: 'Contact Us', es: 'Contáctanos', de: 'Kontaktiere uns', it: 'Contattaci', pt: 'Contacte-nos', nl: 'Neem contact op', ar: 'اتصل بنا', zh: '联系我们' },
  footer_account:       { fr: 'Mon compte', en: 'Account', es: 'Cuenta', de: 'Konto', it: 'Account', pt: 'Conta', nl: 'Account', ar: 'حسابي', zh: '账户' },
  footer_membership:    { fr: 'Adhésion', en: 'Membership', es: 'Membresía', de: 'Mitgliedschaft', it: 'Iscrizione', pt: 'Adesão', nl: 'Lidmaatschap', ar: 'العضوية', zh: '会员' },
  footer_profile:       { fr: 'Profil', en: 'Profile', es: 'Perfil', de: 'Profil', it: 'Profilo', pt: 'Perfil', nl: 'Profiel', ar: 'الملف الشخصي', zh: '个人资料' },
  footer_coupons:       { fr: 'Coupons', en: 'Coupons', es: 'Cupones', de: 'Gutscheine', it: 'Coupon', pt: 'Cupões', nl: 'Kortingsbonnen', ar: 'كوبونات', zh: '优惠券' },
  footer_social:        { fr: 'Réseaux sociaux', en: 'Social Media', es: 'Redes sociales', de: 'Soziale Medien', it: 'Social Media', pt: 'Redes Sociais', nl: 'Sociale Media', ar: 'وسائل التواصل', zh: '社交媒体' },
  footer_copy:          { fr: '©Shopz 2026. Tous droits réservés.', en: '©Shopz 2026. All rights reserved.', es: '©Shopz 2026. Todos los derechos reservados.', de: '©Shopz 2026. Alle Rechte vorbehalten.', it: '©Shopz 2026. Tutti i diritti riservati.', pt: '©Shopz 2026. Todos os direitos reservados.', nl: '©Shopz 2026. Alle rechten voorbehouden.', ar: '©Shopz 2026. جميع الحقوق محفوظة.', zh: '©Shopz 2026。保留所有权利。' },
  footer_terms:         { fr: 'Conditions générales', en: 'Terms and Conditions', es: 'Términos y condiciones', de: 'Allgemeine Geschäftsbedingungen', it: 'Termini e Condizioni', pt: 'Termos e Condições', nl: 'Algemene Voorwaarden', ar: 'الشروط والأحكام', zh: '条款和条件' },
  img_view:             { fr: 'Vue', en: 'View', es: 'Vista', de: 'Ansicht', it: 'Vista', pt: 'Vista', nl: 'Weergave', ar: 'صورة', zh: '视图' },
  img_more:             { fr: '+4 autres', en: '+4 more', es: '+4 más', de: '+4 weitere', it: '+4 altre', pt: '+4 mais', nl: '+4 meer', ar: '+4 المزيد', zh: '+4 更多' },
  aria_stars:           { fr: 'étoiles', en: 'stars', es: 'estrellas', de: 'Sterne', it: 'stelle', pt: 'estrelas', nl: 'sterren', ar: 'نجوم', zh: '星' },
}
